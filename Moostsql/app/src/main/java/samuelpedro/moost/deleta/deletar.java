package samuelpedro.moost.deleta;
...
import samuelpedro.moost.visaogeral.AndroidAdapter;
import samuelpedro.moost.visaogeral.ListaLancamento;
import samuelpedro.moost.visaogeral.VisaoGeral;
import samuelpedro.moost.visaogeral.controlaVisao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayDateInicio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(deletar.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, mDateSetListenerInicio, ano, mes, dia);
        ...
        mDisplayDateFinal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(deletar.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, mDateSetListenerFinal, ano, mes, dia);
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                dialog.show();
            }
        });
